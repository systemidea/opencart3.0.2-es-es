...
$_['text_canceled_success']                             = 'Operación Exitosa: You have succesfully canceled this payment.';
...
$_['text_success']                                      = 'Operación Exitosa: You have modified Square payment module.';
...
$_['text_token_expired']                                = 'Your Square access token has expired. <a href="%s">Cliquear aquí</a> to renew it now.';
$_['text_token_expiry_warning']                         = 'Your Square access token will expire on %s. <a href="%s">Cliquear aquí</a> to renew it now.';
$_['text_token_revoked']                                = 'Your Square access token has expired or has been revoked. <a href="%s">Cliquear aquí</a> to re-authorize the Square extension.';
...
// Error
$_['error_permission']                                  = '<strong>Error:</strong> Sin permiso para modificar payment Square.';
$_['error_permission_recurring']                        = '<strong>Error:</strong> Sin permiso para modificar recurring payments.';
$_['error_transaction_missing']                         = 'Transaction not found.';
$_['error_no_ssl']                                      = '<strong>Error:</strong> SSL is not enabled on your admin panel. Please enable it to finish your configuration.';
