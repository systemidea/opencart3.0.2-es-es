...
$_['text_success']		 = 'Operación Exitosa: Detalles de Cuenta PayPal Direct (UK) account details.';
...
// Error
$_['error_permission']	 = 'Error: Sin permiso para modificar payment PayPal Website Payment Pro (UK).';
