...
$_['error_meta_title']             = 'Title must be between 3 y 32 caracteres.';
$_['error_name']                   = 'Store Name must be between 3 y 32 caracteres.';
$_['error_owner']                  = 'Store Owner must be between 3 y 64 caracteres.';
$_['error_address']                = 'Store Address must be between 10 y 256 caracteres.';
$_['error_email']                  = 'E-Mail Address does not appear to be valid.';
$_['error_telephone']              = 'Telephone must be between 3 y 32 caracteres.';
$_['error_customer_group_display'] = 'You must include the default customer group if you are going to use this feature.';
$_['error_default']                = 'Error: You can not delete your default store.';
$_['error_store']                  = 'Error: This Store cannot be deleted as it is currently assigned to %s orders.';